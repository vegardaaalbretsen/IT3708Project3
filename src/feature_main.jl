...
function run_single_objective_ea(landscape::Landscape;
                                 ...
                                 mutation_probability::Union{Nothing, Real} = 0.0625,
...
function run_nsga2_feature_ea(landscape::Landscape;
                              ...
                              epsilon::Real = 0.0,
                              initial_index::Union{Nothing, Integer} = nothing,
                              population_size::Integer = 300,
                              crossover_probability::Real = 0.60,
                              mutation_probability::Union{Nothing, Real} = 0.1875,
                              log_every::Integer = 0,
                              threaded_evaluation::Bool = Threads.nthreads() > 1,
                              rng::AbstractRNG = Random.default_rng(),
                              keep_history::Bool = false)
