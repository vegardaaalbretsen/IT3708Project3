...
export DATASETS,
       ...
       plot_ea_trace,
       save_ea_trace_plot,
       plot_search_trajectory_network,
       save_search_trajectory_network_plot,
       swarm_trace_plot_data,
       plot_swarm_search_trajectory_network,
       save_swarm_search_trajectory_network_plot,
       plot_swarm_trace,
